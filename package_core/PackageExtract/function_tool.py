...
def get_BGA_parameter_data(QFP_parameter_list, nx, ny):
    ...
    #12.22新加Φ：
    if len(QFP_parameter_list[17]['maybe_data']) > 0:
        parameter_list[9][1] = round(QFP_parameter_list[17]['maybe_data'][0]['max_medium_min'][2], 4)
        parameter_list[9][2] = round(QFP_parameter_list[17]['maybe_data'][0]['max_medium_min'][1], 4)
        parameter_list[9][3] = round(QFP_parameter_list[17]['maybe_data'][0]['max_medium_min'][0], 4)
